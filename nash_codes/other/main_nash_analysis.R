...
ggsave(file.path( outplot, sprintf('example_quandrants_%s.png', mystation)),
       width = 6.5, height = 8, plot=fig)
...
XIor = apply(nwets_sim_origrep$maxrep, 1, sort) + thresh
XIno = apply(nwets_sim_northrep$maxrep, 1, sort) + thresh
XIso = apply(nwets_sim_southrep$maxrep, 1, sort) + thresh
